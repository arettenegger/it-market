  ...
  baseConfigurations: [
    {
      ...
      ram: "32GB DDR5-5600 Dual-Kit",
      ssd: "1TB M.2 NVMe PCIe 4.0 SSD",
      chassis: "Compact Micro-Workstation",
      gpu: "Onboard iGPU (keine dedizierte GPU)",
      description: "Zuverlässiger Büro- & Verwaltungs-PC für Office, Buchhaltung und Multitasking.",
    },
    {
      id: "cfg-business-pro",
      ...
      ram: "64GB DDR5-5600 Dual-Kit",
      ssd: "2TB M.2 NVMe PCIe 5.0 SSD Pro",
      chassis: "Silent Tower Workstation",
      gpu: "NVIDIA RTX 4070 Super 12GB",
      description: "Leistungsstarke Workstation für CAD, Bild-/Videobearbeitung und anspruchsvolle Anwendungen.",
      recommended: true,
    },
    {
      id: "cfg-creator-ai",
      ...
      ram: "128GB Registered ECC DDR5",
      ssd: "4TB Dual M.2 Enterprise RAID 1",
      chassis: "Silent Tower Workstation",
      gpu: "NVIDIA RTX 4080 Super 16GB",
      description: "Für 3D-Rendering, KI-Training und datenintensive Profi-Anwendungen.",
    },
    {
      id: "cfg-server-rack",
      ...
      ram: "128GB Registered ECC DDR5",
      ssd: "4TB Dual M.2 Enterprise RAID 1",
      chassis: "Enterprise 2U Server Rackmount",
      gpu: "Keine dedizierte GPU",
      description: "Ausfallsicherer Server für Virtualisierung, Datenbanken und zentrale Dienste.",
    },
    {
      id: "cfg-nas-host",
      ...
      chassis: "Compact Micro-Workstation",
      gpu: "Onboard iGPU (keine dedizierte GPU)",
      description: "Kompakter Server für kleine Netzwerke, NAS-Backup und Hosting.",
    },
  ],
  networkOptions: [
